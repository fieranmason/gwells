...
|| tablename FROM pg_tables WHERE tablename NOT IN ('pg_authid', 'pg_db_role_setting', 'pg_tablespace', 'pg_pltemplate', 'pg_auth_members', 'pg_shdepend', 'pg_shdescription', 'pg_replication_origin', 'pg_shseclabel', 'pg_database')") ;
